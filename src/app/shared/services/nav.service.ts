...
export class NavService {
	...
	MENUITEMS: Menu[] = [
		{
			title: 'Dashboard', icon: 'folder-plus', type: 'sub', badgeType: 'primary', badgeValue: 'new documents', active: false, children: [
				...
				{
					path: '/sample-page', title: 'K1 2020', icon: 'file', type: 'link'
		...
		// },
		{
			title: 'Newsletter', icon: 'book', type: 'sub', active: false, children: [
				...
				{ path: '/advance/lpnewsletter', title: 'Newsletter', type: 'link' }
